        ...
        <Container>
            ...
            <Flex className="sm:flex sm:max-lg:flex-wrap sm:max-md:justify-between md:gap-x-10">
                <div className='sm:max-w-[300px] md:max-lg:max-w-[345px] lg:max-w-[370px]'>
                    <Product src="assets/productImg (5).png" badge={true}/>
                </div>
                <div className='sm:max-w-[300px] md:max-lg:max-w-[345px] lg:max-w-[370px]'>
                    <Product src="assets/productImg (6).png" badge={true}/>
                </div>
                <div className='sm:max-w-[300px] md:max-lg:max-w-[345px] lg:max-w-[370px]'>
                    <Product src="assets/productImg (7).png" badge={true}/>
                </div>
                <div className='sm:max-w-[300px] md:max-lg:max-w-[345px] lg:max-w-[370px]'>
                    <Product src="assets/productImg (8).png" badge={true}/>
                </div>
            </Flex>
        </Container>
    </div>
